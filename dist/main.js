...
const toggleRouteFix = document.getElementById('toggle-route-fix');
// --- 2. データレイヤーの管理 ---
const layerGroups = {
...
toggleRouteFix.addEventListener('change', (e) => toggleLayer(layerGroups.route_fix, e.target.checked));
// --- 5. GPSログ記録機能 ---
